...
[
  {
    label: jsxRuntime.jsx(
      'span',
      Object.assign(
        { style: { fontFamily: 'SmileySans', fontSize: 16 } },
        { children: '\u5F97\u610F\u9ED1' },
      ),
    ),
    value: 'SmileySans',
  },
  {
    label: jsxRuntime.jsx(
      'span',
      Object.assign(
        { style: { fontFamily: '霞鹜新晰黑', fontSize: 16 } },
        { children: '\u971E\u9E5C\u65B0\u6670\u9ED1' },
      ),
    ),
    value: '霞鹜新晰黑',
  },
  {
    label: jsxRuntime.jsx(
      'span',
      Object.assign(
        { style: { fontFamily: '霞鹜文楷', fontSize: 16 } },
        { children: '\u971E\u9E5C\u6587\u6977' },
      ),
    ),
    value: '霞鹜文楷',
  },
  {
    label: jsxRuntime.jsx(
      'span',
      Object.assign(
        { style: { fontFamily: '小赖字体', fontSize: 16 } },
        { children: '\u5C0F\u8D56\u5B57\u4F53' },
      ),
    ),
    value: '小赖字体',
  },
  {
    label: jsxRuntime.jsx(
      'span',
      Object.assign(
        { style: { fontFamily: '悠哉字体', fontSize: 16 } },
        { children: '\u60A0\u54C9\u5B57\u4F53' },
      ),
    ),
    value: '悠哉字体',
  },
  {
    label: jsxRuntime.jsx(
      'span',
      Object.assign(
        { style: { fontFamily: 'AlibabaPuHuiTi', fontSize: 16 } },
        { children: '\u963F\u91CC\u5DF4\u5DF4\u666E\u60E0\u4F53' },
      ),
    ),
  ...
  },
  {
    label: jsxRuntime.jsx(
      'span',
      Object.assign(
        { style: { fontFamily: '霞鹜尚智黑', fontSize: 16 } },
        { children: '\u971E\u9E5C\u5C1A\u667A\u9ED1' },
      ),
    ),
    value: '霞鹜尚智黑',
  },
  {
    label: jsxRuntime.jsx(
      'span',
      Object.assign(
        { style: { fontFamily: 'SourceHanSans', fontSize: 16 } },
        { children: '\u601D\u6E90\u9ED1\u4F53' },
      ),
    ),
    value: 'SourceHanSans',
  },
  {
    label: jsxRuntime.jsx(
      'span',
      Object.assign(
        { style: { fontFamily: 'SourceHanSerif', fontSize: 16 } },
        { children: '\u601D\u6E90\u5B8B\u4F53' },
      ),
    ),
  ...
  },
  {
    label: jsxRuntime.jsx(
      'span',
      Object.assign(
        { style: { fontFamily: '方正楷体', fontSize: 16 } },
        { children: '\u65B9\u6B63\u6977\u4F53' },
      ),
    ),
    value: '方正楷体',
  },
  {
    label: jsxRuntime.jsx(
      'span',
      Object.assign(
        { style: { fontFamily: '包图小白体', fontSize: 16 } },
        { children: '\u5305\u56FE\u5C0F\u767D\u4F53' },
      ),
    ),
    value: '包图小白体',
  },
  {
    label: jsxRuntime.jsx(
      'span',
      Object.assign(
        { style: { fontFamily: '手写杂字体', fontSize: 16 } },
        { children: '\u624B\u5199\u6742\u5B57\u4F53' },
      ),
    ),
    value: '手写杂字体',
  },
  {
    label: jsxRuntime.jsx(
      'span',
      Object.assign(
        { style: { fontFamily: '胡晓波男神体', fontSize: 16 } },
        { children: '\u80E1\u6653\u6CE2\u7537\u795E\u4F53' },
      ),
    ),
    value: '胡晓波男神体',
  },
  {
    label: jsxRuntime.jsx(
      'span',
      Object.assign(
        { style: { fontFamily: '胡晓波骚包体', fontSize: 16 } },
        { children: '\u80E1\u6653\u6CE2\u9A9A\u5305\u4F53' },
      ),
    ),
    value: '胡晓波骚包体',
  },
  {
    label: jsxRuntime.jsx(
      'span',
      Object.assign(
        { style: { fontFamily: '站酷快乐体', fontSize: 16 } },
        { children: '\u7AD9\u9177\u5FEB\u4E50\u4F53' },
      ),
    ),
    value: '站酷快乐体',
  },
  {
    label: jsxRuntime.jsx(
      'span',
      Object.assign(
        { style: { fontFamily: '站酷文艺体', fontSize: 16 } },
        { children: '\u7AD9\u9177\u6587\u827A\u4F53' },
      ),
    ),
    value: '站酷文艺体',
  },
  {
    label: jsxRuntime.jsx(
      'span',
      Object.assign(
        { style: { fontFamily: '站酷小薇LOGO体', fontSize: 16 } },
        { children: '\u7AD9\u9177\u5C0F\u8587LOGO\u4F53' },
      ),
    ),
    value: '站酷小薇LOGO体',
...
const FONT_PRESET_FAMILY_LIST_GOOGLE_FONT = COMPLETE_GOOGLE_FONTS.map(f => ({
  label: jsxRuntime.jsx(
    'span',
    Object.assign({ style: { fontFamily: f, fontSize: 16 } }, { children: f }),
  ),
  value: f,
}));
...
const loadPresetGoogleFonts = async () => {
  googleFonts__default.default.add(
    COMPLETE_GOOGLE_FONTS.reduce((acc, f) => {
      acc[f] = true;
      return acc;
    }, {}),
  );
...
const loadFont = async f => {
  ...
  const item = FONT_PRESET_FAMILY_LIST_GOOGLE_FONT.find(
    _item => _item.value === f,
  );
...
const drawTextPath = (textbox, offset) => {
  ...
  const path = new fabric$1.fabric.Path(
...
const createTextbox = async options => {
  let _a = options || {},
    { text = '', fontFamily = TEXTBOX_DEFAULT_CONFIG.fontFamily, canvas } = _a,
    rest = __rest(_a, ['text', 'fontFamily', 'canvas']);
  if (typeof text === 'function') {
    text = text();
  }
  let tmpPathInfo = { hasPath: false, offset: 100 };
  const textBox = new fabric$1.fabric.FText(
    text || translate('panel.text.add'),
    Object.assign(
      Object.assign(Object.assign({}, TEXTBOX_DEFAULT_CONFIG), rest),
      { fontFamily, pathAlign: 'center', id: uuid() },
    ),
  );
...
function TextPanel() {
  ...
  const handleAddText = async options => {
    await createTextbox(
      Object.assign(Object.assign({}, options), { canvas: editor.canvas }),
    );
  };
  return jsxRuntime.jsxs(
    'div',
        ...
        children: [
          jsxRuntime.jsx(
            ...
            Object.assign(
              ...
              { children: t('panel.text.add') },
            ),
          ),
          jsxRuntime.jsx(PresetFontPanel, { addTextBox: handleAddText }),
        ],
      },
    ),
  );
...
const loadImageDom = async url => {
  return new Promise((resolve, reject) => {
    fabric$1.fabric.util.loadImage(
      url,
      img => {
        if (img) {
          return resolve(img);
...
const createImage = async options => {
  const _a = options || {},
    { imageSource, canvas } = _a,
    rest = __rest(_a, ['imageSource', 'canvas']);
  let img;
  try {
  ...
  if (!img) return;
  img.set(
    Object.assign(Object.assign({}, rest), { paintFirst: 'fill', id: uuid() }),
  );
  ...
  return jsxRuntime.jsxs('div', {
    children: [
      jsxRuntime.jsx(
        antd.Button,
        Object.assign(
          { type: 'primary', size: 'large', onClick: handleClick },
          rest,
          { children: t('panel.image.local') },
        ),
      ),
...
function RemoteImageSelector(props) {
  ...
  return jsxRuntime.jsx(
    ...
    Object.assign(
      {
        content: jsxRuntime.jsxs(antd.Space.Compact, {
          children: [
      ...
      },
      {
        children: jsxRuntime.jsx(
          antd.Button,
          Object.assign({ type: 'primary', size: 'large' }, rest, {
            children: t('panel.image.remote'),
          }),
        ),
      },
    ),
...
function ImageSelector(props) {
  ...
  return jsxRuntime.jsxs(
    antd.Flex,
    Object.assign(
      { gap: 10, justify: 'space-around' },
      {
        children: [
          jsxRuntime.jsx(
            LocalImageSelector,
            Object.assign({}, rest, { onChange: onChange }),
          ),
          jsxRuntime.jsx(
            RemoteImageSelector,
            Object.assign({}, rest, { onChange: onChange }),
...
function ImagePanel() {
  ...
  return jsxRuntime.jsx(
    ...
    Object.assign(
      { className: 'fabritor-panel-wrapper' },
      { children: jsxRuntime.jsx(ImageSelector, { onChange: addImage }) },
    ),
  );
}
...
const drawLine = options => {
  const { points, canvas } = options,
    rest = __rest(options, ['points', 'canvas']);
  const line = new fabric$1.fabric.FLine(
    points || [0, 0, 300, 0],
    Object.assign(
      {
        strokeWidth: 4,
...
const drawArrowLine = options => {
  const { points, canvas } = options,
    rest = __rest(options, ['points', 'canvas']);
  const arrow = new fabric$1.fabric.FArrow(
    points || [0, 0, 300, 0],
    Object.assign(
      {
        strokeWidth: 4,
...
const drawTriArrowLine = options => {
  const { points, canvas } = options,
    rest = __rest(options, ['points', 'canvas']);
  const arrow = new fabric$1.fabric.FTriArrow(
    points || [0, 0, 300, 0],
    Object.assign(
      {
        strokeWidth: 4,
...
function createRect(options) {
  const _a = options || {},
    { canvas } = _a,
    rest = __rest(_a, ['canvas']);
  const rect = new fabric$1.fabric.Rect(
    Object.assign({ id: uuid(), width: 200, height: 200 }, rest),
  );
...
function createShape(ShapeClass, options) {
  const _a = options || {},
    { points, canvas } = _a,
    rest = __rest(_a, ['points', 'canvas']);
  let object;
  if (ShapeClass === fabric$1.fabric.Polygon) {
    object = new fabric$1.fabric.Polygon(
      points,
      Object.assign({ id: uuid() }, rest),
    );
  } else {
...
const createPathFromSvg = async options => {
  const _a = options || {},
    { svgString, canvas } = _a,
    rest = __rest(_a, ['svgString', 'canvas']);
...
function ShapePanel() {
  ...
  const addShape = item => {
    ...
    switch (key) {
      ...
      default:
        createShape(
          item.shape,
          Object.assign(Object.assign({}, options), { canvas }),
        );
        break;
    }
  };
  ...
  return jsxRuntime.jsxs(
    ...
    Object.assign(
      ...
      {
        children: [
          jsxRuntime.jsx(Title$1, { children: t('panel.material.line') }),
          jsxRuntime.jsx(
            antd.Flex,
            Object.assign(
              { gap: 10, wrap: 'wrap', justify: 'space-around' },
              {
                children: LineTypeList.map(item =>
                  jsxRuntime.jsx(
                    'div',
                    Object.assign(
                      {
          ...
          jsxRuntime.jsx(Title$1, { children: t('panel.material.shape') }),
          jsxRuntime.jsx(
            antd.Flex,
            Object.assign(
              { gap: 10, wrap: 'wrap', justify: 'space-around' },
              {
                children: ShapeTypeList.map(item =>
                  jsxRuntime.jsx(
                    'div',
                    Object.assign(
                      {
              ...
              Object.assign(
                { style: { position: 'relative' } },
                {
                  children: jsxRuntime.jsx('span', {
                    children: t('panel.material.hand_drawn'),
                  }),
                },
              ),
            ),
          ...
          jsxRuntime.jsx(
            ...
            Object.assign(
              { gap: 10, wrap: 'wrap', justify: 'space-around' },
              {
                children: RoughTypeList.map(item =>
                  jsxRuntime.jsx(
                    'div',
                    Object.assign(
                      {
...
var BrushList = [
  ...
  },
  {
    ...
    title: jsxRuntime.jsx(reactI18next.Trans, {
      i18nKey: 'panel.paint.marker_pen',
    }),
    options: {
      color: '#FF0000',
      width: 36,
        ...
        Object.assign(
          ...
          },
          {
            children: jsxRuntime.jsx(
              'linearGradient',
              Object.assign(
                { id: 'colorsetter-icon-gradient', x2: '1', y2: '1' },
                {
                  children:
                    (_a =
                      value === null || value === void 0
                        ? void 0
                        : value.gradient) === null || _a === void 0
                      ? void 0
                      : _a.colorStops.map(stop =>
                          jsxRuntime.jsx('stop', {
  ...
  return jsxRuntime.jsxs(
    ...
    Object.assign(
      ...
      },
      {
        children: [
          showPenTip
            ? jsxRuntime.jsx(FormItem$d, {
                label: jsxRuntime.jsx(
                  'span',
                  Object.assign(
                    { style: { fontSize: 15, fontWeight: 'bold' } },
                    { children: t('panel.paint.title') },
                  ),
                ),
              })
            : null,
          jsxRuntime.jsx(
            ...
            Object.assign(
              {
                label: showFillConfig
                  ? t('common.stroke')
                  : t('common.stroke_color'),
                name: 'color',
              },
              {
                children: jsxRuntime.jsx(SolidColorSetter, {
                  onChange: fireEvent,
                }),
              },
            ),
          ...
          jsxRuntime.jsx(
            FormItem$d,
            Object.assign(
              { label: t('common.line_width'), name: 'width' },
              {
                children: jsxRuntime.jsx(SliderInputNumber, {
                  min: 1,
                  max: 100,
          ...
          showFillConfig
            ? jsxRuntime.jsx(
                FormItem$d,
                Object.assign(
                  { label: t('common.fill'), name: 'fill' },
                  {
                    children: jsxRuntime.jsx(ColorSetter, {
                      onChange: fireEvent,
                    }),
                  },
                ),
          ...
          jsxRuntime.jsx(
            FormItem$d,
            Object.assign(
              { label: t('common.color'), name: ['shadow', 'color'] },
              {
                children: jsxRuntime.jsx(SolidColorSetter, {
                  onChange: fireEvent,
                }),
          ...
          jsxRuntime.jsx(
            FormItem$d,
            Object.assign(
              { label: t('common.width'), name: ['shadow', 'width'] },
              {
                children: jsxRuntime.jsx(SliderInputNumber, {
                  min: 0,
                  max: 50,
          ...
          jsxRuntime.jsx(
            FormItem$d,
            Object.assign(
              { label: t('common.offset'), name: ['shadow', 'offset'] },
              {
                children: jsxRuntime.jsx(SliderInputNumber, {
                  min: 0,
                  max: 20,
...
function PaintPanel() {
  ...
  const handleBrushChange = options => {
    ...
    if (options.shadow) {
      ...
      editor.canvas.freeDrawingBrush.shadow = new fabric$1.fabric.Shadow(
        newShadowObject,
      );
    }
  };
      ...
      { className: 'fabritor-panel-wrapper' },
      {
        children: [
          jsxRuntime.jsx(
            antd.Flex,
            Object.assign(
              { wrap: 'wrap', justify: 'space-around' },
              {
                children: BrushList.map((item, index) =>
                  jsxRuntime.jsx(
                    antd.Tooltip,
                    Object.assign(
                      { trigger: 'hover', title: item.title },
                      {
                        children: jsxRuntime.jsx(
                          'div',
                          Object.assign(
          ...
          jsxRuntime.jsx(PathSetterForm, {
            onChange: handleBrushChange,
            value: penFormValues,
            showPenTip: true,
          }),
          jsxRuntime.jsx(Title$1, { children: t('common.operate') }),
          jsxRuntime.jsx(
            antd.Flex,
            Object.assign(
              { wrap: 'wrap', justify: 'space-around' },
...
const linePositionHandler = (x, y) => {
  return (dim, finalMatrix, fabricObject) => {
    if (
      fabricObject === null || fabricObject === void 0
        ? void 0
        : fabricObject.canvas
    ) {
      const points = fabricObject.calcLinePoints();
      const localPoint = new fabric$1.fabric.Point(points[x], points[y]);
      const point = fabric$1.fabric.util.transformPoint(
        localPoint,
        fabric$1.fabric.util.multiplyTransformMatrices(
...
const ContextMenuItem = props => {
  ...
  return jsxRuntime.jsxs(
    antd.Flex,
    Object.assign(
      { gap: 68, justify: 'space-between' },
      {
        children: [
          jsxRuntime.jsx('span', { children: label }),
          jsxRuntime.jsx('span', { children: `${getCmdkey()} ${keyboard}` }),
        ],
      },
    ),
  );
...
const ContextMenu = (props, ref) => {
  ...
  const renderMenuItems = () => {
    if (!object || object.id === SKETCH_ID) {
      return [
        {
          label: jsxRuntime.jsx(ContextMenuItem, {
    ...
    const menuItems = [
      ...
      },
      {
        label: jsxRuntime.jsx('span', {
          children: t('setter.common.create_a_copy'),
        }),
        key: 'copy&paste',
      },
      {
    ...
    Object.assign(
      { className: 'fabritor-panel-wrapper' },
      {
        children: layers.length
          ? jsxRuntime.jsx(antd.List, {
              dataSource: layers,
              renderItem: item =>
                jsxRuntime.jsx(
                  ContextMenu$1,
                  Object.assign(
                    { object: item.object, noCareOpen: true },
                    {
                      children: jsxRuntime.jsx(
                        antd.List.Item,
                        Object.assign(
                              ...
                              Object.assign(
                                ...
                                },
                                {
                                  children: [
                                    ...
                                    item.group
                                      ? jsxRuntime.jsx(icons.GroupOutlined, {
                                          style: {
                                            fontSize: 18,
          ...
          : jsxRuntime.jsx(antd.Empty, {
              image: null,
              description: jsxRuntime.jsxs('div', {
                children: [
                  jsxRuntime.jsx(icons.HeartTwoTone, {
                    twoToneColor: '#eb2f96',
                    style: { fontSize: 40 },
                  }),
                  jsxRuntime.jsx(
                    ...
                    Object.assign(
                      ...
                      { children: t('panel.design.start') },
                    ),
                  ),
                  jsxRuntime.jsx(antd.Divider, {}),
                  jsxRuntime.jsx(
                    antd.Button,
                    Object.assign(
                      { onClick: loadDemo },
                      { children: t('panel.design.start_demo') },
                    ),
                  ),
                ],
              }),
    ...
    Object.assign(
      {
        ...
        title: jsxRuntime.jsxs(
          antd.Flex,
          Object.assign(
            { justify: 'space-between' },
            {
              children: [
                jsxRuntime.jsx(icons.LeftOutlined, { onClick: back2AppList }),
                jsxRuntime.jsx('p', { children: title }),
              ],
            },
          ),
        ),
...
function QRCodePanel(props) {
  ...
  return jsxRuntime.jsxs(
    AppSubPanel,
    Object.assign(
      { title: t('panel.app.qrcode'), back: back },
      {
        children: [
          jsxRuntime.jsxs(
            antd.Form,
            Object.assign(
              { form: form, onValuesChange: handleValuesChange },
              {
                children: [
                  jsxRuntime.jsx(
                    FormItem$c,
                    Object.assign(
                      { name: 'value', label: t('common.text') },
                      { children: jsxRuntime.jsx(antd.Input, {}) },
                    ),
                  ),
                  jsxRuntime.jsx(
                    FormItem$c,
                    Object.assign(
                      { name: 'size', label: t('common.size') },
            ...
            items: [
              {
                ...
                children: jsxRuntime.jsxs(
                  antd.Form,
                  Object.assign(
                    { form: form2, onValuesChange: handleValuesChange },
                    {
                      children: [
                        jsxRuntime.jsx(
                          FormItem$c,
                        ...
                        jsxRuntime.jsx(
                          ...
                          Object.assign(
                            {
                              name: 'bgColor',
                              label: t('common.background_color'),
                            },
                            { children: jsxRuntime.jsx(SolidColorSetter, {}) },
                          ),
                        ),
                        jsxRuntime.jsx(
                          ...
                          Object.assign(
                            {
                              name: 'errorLevel',
                              label: t('panel.app.error_level'),
                            },
                            {
                              children: jsxRuntime.jsx(antd.Radio.Group, {
                                options: ['L', 'M', 'Q', 'H'],
                              }),
                            },
                          ),
                        ...
                        jsxRuntime.jsx(
                          FormItem$c,
                          Object.assign(
                            { name: 'icon', label: t('panel.app.image') },
                            {
                              children: jsxRuntime.jsx(antd.Input, {
                                placeholder: t('panel.app.only_image_url'),
                              }),
                            },
                          ),
                        ),
                ...
                Object.assign(
                  ...
                  },
                  {
                    children: [
                      jsxRuntime.jsx(
                        antd.QRCode,
                        Object.assign({ type: 'canvas' }, QRCodeConfig, {
                          style: { maxWidth: 200 },
                        }),
                      ),
                      jsxRuntime.jsx(
                        antd.Button,
                        Object.assign(
                          { type: 'primary', onClick: add2Canvas },
                          { children: t('panel.app.add') },
                        ),
                      ),
                    ],
                  },
...
function EmojiPanel(props) {
  ...
  return jsxRuntime.jsx(
    AppSubPanel,
    Object.assign(
      { title: 'Emoji', back: back },
      {
        children: jsxRuntime.jsx(Picker__default.default, {
...
function AppPanel() {
          ...
          children: APP_LIST.map(item =>
            jsxRuntime.jsx(
              ...
              Object.assign(
                ...
                {
                  children: jsxRuntime.jsx(antd.Card.Meta, {
  ...
  return jsxRuntime.jsx('div', {
    children: app ? renderApp() : renderAppList(),
  });
}
...
function Panel() {
  ...
  const renderLabel = item => {
    return jsxRuntime.jsxs(
      antd.Flex,
      Object.assign(
        { vertical: true, justify: 'center' },
        {
          children: [
            jsxRuntime.jsx('div', { children: item.icon }),
            jsxRuntime.jsx('div', { children: item.label }),
          ],
        },
      ),
    );
  ...
  return jsxRuntime.jsx(
    Sider$1,
    Object.assign(
      { style: siderStyle$1, width: PANEL_WIDTH, className: 'fabritor-sider' },
      {
        children: jsxRuntime.jsx(antd.Tabs, {
          tabPosition: 'left',
    ...
    Object.assign(
      {
        prefix: jsxRuntime.jsx(
          ...
          Object.assign(
            ...
            { children: prefixText || t('setter.size.width') },
          ),
        ),
        controls: false,
        changeOnBlur: true,
...
function SizeSetter(props) {
  ...
  return jsxRuntime.jsxs(
    ...
    Object.assign(
      ...
      {
        children: [
          jsxRuntime.jsx(SizeInput, {
            value:
              innerValue === null || innerValue === void 0
                ? void 0
                : innerValue[0],
            onChange: v => {
              handleChange(v, 0);
      ...
      },
      {
        children: [
          jsxRuntime.jsx(
            FormItem$b,
            Object.assign(
              { label: t('setter.sketch.size'), name: 'size' },
              { children: jsxRuntime.jsx(SizeSetter, {}) },
            ),
          ),
          jsxRuntime.jsx(
            FormItem$b,
            Object.assign(
              { label: t('setter.sketch.fill'), name: 'fill' },
              { children: jsxRuntime.jsx(ColorSetter, { type: 'sketch' }) },
            ),
          ),
        ],
      },
...
function FontStylePanel(props) {
  ...
  const handleClick = v => {
    onChange &&
      onChange(Object.assign(Object.assign({}, value), { [v]: !value[v] }));
  };
  return jsxRuntime.jsx(
    antd.Space.Compact,
    Object.assign(
      { block: true },
      {
        children: FONT_STYLES.map(FONT_STYLE =>
          jsxRuntime.jsx(
            antd.Button,
            {
              style: { width: 46 },
              icon: jsxRuntime.jsx(FONT_STYLE.icon, {
                style: {
                  color: (
                    value === null || value === void 0
                      ? void 0
...
function AlignSetter(props) {
  ...
  return jsxRuntime.jsx(
    antd.Radio.Group,
    Object.assign({ value: value }, rest, {
...
function FList(props) {
  const { dataSource, renderItemChildren } = props,
    rest = __rest(props, ['dataSource', 'renderItemChildren']);
  return jsxRuntime.jsx(
    antd.List,
    Object.assign(
      {
              ...
              Object.assign(
                {
                  ...
                  icon: jsxRuntime.jsx(icons.LeftOutlined, {}),
                  style: { marginLeft: -10 },
                },
                { children: title },
              ),
...
function TextShadow(props) {
  ...
  return jsxRuntime.jsxs(
    antd.Form,
    Object.assign(
      { form: form, onValuesChange: handleChange, colon: false },
      {
        children: [
          jsxRuntime.jsx(FormItem$a, {
            label: jsxRuntime.jsx(
              'span',
              Object.assign(
                { style: { fontSize: 15, fontWeight: 'bold' } },
          ...
          jsxRuntime.jsx(
            FormItem$a,
            Object.assign(
              { label: t('common.color'), name: 'color' },
              { children: jsxRuntime.jsx(SolidColorSetter, {}) },
            ),
          ),
          jsxRuntime.jsx(
            FormItem$a,
            Object.assign(
              { label: t('common.blur'), name: 'blur' },
              { children: jsxRuntime.jsx(antd.Slider, { min: 0, max: 20 }) },
            ),
          ),
          jsxRuntime.jsx(
            FormItem$a,
            Object.assign(
              ...
              {
                children: jsxRuntime.jsx(antd.Slider, { min: -180, max: 180 }),
              },
            ),
          ),
        ],
              ...
              { gutter: 16 },
              {
                children: [
                  jsxRuntime.jsx(antd.Col, {
                    children: jsxRuntime.jsx(FormItem$9, {
                      label: jsxRuntime.jsx(
                        'span',
                        Object.assign(
                          { style: { fontSize: 15, fontWeight: 'bold' } },
                          { children: t('setter.text.fx.text_path') },
                        ),
                      ),
                    }),
                  }),
                  jsxRuntime.jsx(antd.Col, {
                    children: jsxRuntime.jsx(
                      FormItem$9,
                      Object.assign(
                        { name: 'enable', valuePropName: 'checked' },
                        { children: jsxRuntime.jsx(antd.Switch, {}) },
                      ),
                    ),
                  }),
                ],
...
function TextFx() {
  ...
  const initObjectFx = () => {
    ...
    form.setFieldsValue({
      ...
      shadow: {
        color:
          ((_a = object.shadow) === null || _a === void 0
            ? void 0
            : _a.color) ||
          object.stroke ||
          '#000000',
        blur:
          ((_b = object.shadow) === null || _b === void 0 ? void 0 : _b.blur) ||
          0,
        offset:
          ((_c = object.shadow) === null || _c === void 0
            ? void 0
            : _c.offsetX) || 0,
      },
      path: {
      ...
      pattern: {
        ...
        url:
          (_d = fill === null || fill === void 0 ? void 0 : fill.source) ===
            null || _d === void 0
            ? void 0
            : _d.src,
      },
  ...
  return jsxRuntime.jsxs(
    ...
    Object.assign(
      ...
      {
        children: [
          jsxRuntime.jsx(FormItem$8, {
            label: jsxRuntime.jsx(
              'span',
              Object.assign(
                { style: { fontSize: 15, fontWeight: 'bold' } },
                { children: t('common.stroke') },
              ),
            ),
          }),
          jsxRuntime.jsx(
            FormItem$8,
            Object.assign(
              { label: t('common.stroke_color'), name: 'stroke' },
              { children: jsxRuntime.jsx(ColorSetter, {}) },
            ),
          ),
          jsxRuntime.jsx(
            FormItem$8,
            Object.assign(
              { label: t('common.stroke_width'), name: 'strokeWidth' },
              {
                children: jsxRuntime.jsx(SliderInputNumber, {
                  min: 0,
                  max: 20,
          ...
          jsxRuntime.jsx(
            FormItem$8,
            Object.assign(
              { name: 'shadow', style: { marginBottom: 0 } },
              { children: jsxRuntime.jsx(TextShadow, {}) },
            ),
          ),
          jsxRuntime.jsx(
            FormItem$8,
            Object.assign(
              { name: 'path', style: { marginBottom: 0 } },
...
function TextSetter() {
  ...
  const handleFontStyles = styles => {
    object.set({
      fontWeight: (styles === null || styles === void 0 ? void 0 : styles.bold)
        ? 'bold'
        : 'normal',
      fontStyle: (styles === null || styles === void 0 ? void 0 : styles.italic)
        ? 'italic'
        : 'normal',
  ...
  const handleValuesChange = async values => {
    const keys = Object.keys(values);
    if (!(keys === null || keys === void 0 ? void 0 : keys.length)) return;
    for (let key of keys) {
      if (key === 'fontStyles') {
  ...
  return jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [
      jsxRuntime.jsxs(
        antd.Form,
        Object.assign(
          { form: form, onValuesChange: handleValuesChange, colon: false },
          {
            children: [
              jsxRuntime.jsx(
                FormItem$7,
                Object.assign(
                  { name: 'fontFamily', label: t('setter.text.font_family') },
                  {
                    children: jsxRuntime.jsx(antd.Select, {
              ...
              jsxRuntime.jsx(
                FormItem$7,
                Object.assign(
                  { name: 'fontSize', label: t('setter.text.font_size') },
                  {
                    children: jsxRuntime.jsx(SliderInputNumber, {
                      max: 400,
                      onChangeComplete: () => {
              ...
              jsxRuntime.jsx(
                FormItem$7,
                Object.assign(
                  { name: 'fill', label: t('setter.text.fill') },
                  {
                    children: jsxRuntime.jsx(ColorSetter, {
                      type: 'fontColor',
                      defaultColor: '#000000',
              ...
              jsxRuntime.jsx(
                FormItem$7,
                Object.assign(
                  { name: 'textAlign', label: t('setter.text.text_align') },
                  { children: jsxRuntime.jsx(AlignSetter, {}) },
                ),
              ),
              jsxRuntime.jsx(
                FormItem$7,
                Object.assign(
                  { name: 'fontStyles', label: t('setter.text.font_styles') },
                  { children: jsxRuntime.jsx(FontStylePanel, {}) },
                ),
              ),
              jsxRuntime.jsx(
                FormItem$7,
                Object.assign(
                  { name: 'charSpacing', label: t('setter.text.char_spacing') },
                  {
                    children: jsxRuntime.jsx(SliderInputNumber, {
                      min: -200,
                      max: 800,
              ...
              jsxRuntime.jsx(
                FormItem$7,
                Object.assign(
                  { name: 'lineHeight', label: t('setter.text.line_height') },
                  {
                    children: jsxRuntime.jsx(SliderInputNumber, {
                      min: 0.5,
                      max: 2.5,
        ...
        renderItemChildren: item =>
          jsxRuntime.jsxs(jsxRuntime.Fragment, {
            children: [
              ...
              jsxRuntime.jsx(icons.RightOutlined, {}),
            ],
          }),
      }),
      jsxRuntime.jsx(
        ...
        Object.assign(
          ...
          { children: jsxRuntime.jsx(TextFx, {}) },
        ),
      ),
    ],
  });
...
function ReplaceSetter(props) {
  ...
  return jsxRuntime.jsx(
    ...
    Object.assign(
      {
        content: jsxRuntime.jsx(ImageSelector, {
          size: 'middle',
          type: 'default',
          onChange: onChange,
        }),
          ...
          Object.assign(
            {
              type: 'primary',
              block: true,
              icon: jsxRuntime.jsx(icons.FileImageOutlined, {}),
            },
            { children: t('setter.image.replace') },
          ),
        ),
      },
    ),
      ...
      { form: form, onValuesChange: handleChange, colon: false },
      {
        children: [
              ...
              },
              {
                children: jsxRuntime.jsx(
                  ...
                  Object.assign(
                    { onChange: fireEvent },
                    {
                      children: BORDER_TYPES.map(item =>
                        jsxRuntime.jsx(
                          antd.Radio.Button,
                          Object.assign(
                            { value: item.key },
          ...
          jsxRuntime.jsx(
            FormItem$6,
            Object.assign(
              { name: 'stroke', label: t('common.stroke_color') },
              {
                children: jsxRuntime.jsx(SolidColorSetter, {
                  onChange: fireEvent,
                }),
          ...
          jsxRuntime.jsx(
            FormItem$6,
            Object.assign(
              { name: 'strokeWidth', label: t('common.stroke_width') },
              {
                children: jsxRuntime.jsx(SliderInputNumber, {
                  min: 1,
                  max: 100,
          ...
          jsxRuntime.jsx(
            FormItem$6,
            Object.assign(
              { name: 'borderRadius', label: t('common.round') },
              {
                children: jsxRuntime.jsx(SliderInputNumber, {
                  min: 0,
                  max: 200,
    ...
    children: [
      jsxRuntime.jsx(
        ...
        Object.assign(
          {
            block: true,
            icon: jsxRuntime.jsx(icons.BorderOutlined, {}),
            onClick: () => {
              setShowMore(true);
            },
          },
          { children: t('common.border') },
        ),
      ),
      jsxRuntime.jsx(
        MoreConfigWrapper,
        Object.assign(
          { open: showMore, setOpen: setShowMore, title: t('common.border') },
          {
            children: jsxRuntime.jsx(
              'div',
              Object.assign(
                { style: { marginTop: 24 } },
                {
                  children: jsxRuntime.jsx(BorderSetter$1, {
                    value: value,
                    onChange: onChange,
                  }),
                },
    ...
    children: [
      jsxRuntime.jsx(
        ...
        Object.assign(
          {
            block: true,
            icon: jsxRuntime.jsx(icons.ExpandOutlined, {}),
            onClick: startCrop,
          },
          { children: t('setter.image.crop') },
        ),
      ),
      showCrop
        ? jsxRuntime.jsxs(
                            ...
                            { block: true },
                            {
                              children: [
                                ...
                                jsxRuntime.jsx(antd.Button, {
                                  icon: jsxRuntime.jsx(icons.CloseOutlined, {}),
                                  onClick: cancel,
                                }),
                                jsxRuntime.jsx(antd.Button, {
                                  icon: jsxRuntime.jsx(icons.CheckOutlined, {}),
                                  onClick: handleCrop,
                                }),
                              ],
                            },
...
function RadioImageGroup(props) {
  ...
  const handleChange = (v, key) => {
    onChange === null || onChange === void 0
      ? void 0
      : onChange(Object.assign(Object.assign({}, value), { [key]: v }));
  };
  return jsxRuntime.jsx(
    'div',
    Object.assign(
      { className: 'fabritor-radio-image-group' },
      {
        children: COLOR_FILTER_LIST.map(option =>
          jsxRuntime.jsxs(
            'div',
            Object.assign(
              {
                ...
                children: [
                  jsxRuntime.jsx(
                    ...
                    Object.assign(
                      ...
                      { children: jsxRuntime.jsx('img', { src: option.src }) },
                    ),
                  ),
                  jsxRuntime.jsx('span', { children: option.label }),
                  option.value === 'Blur' &&
                  (value === null || value === void 0 ? void 0 : value.type) ===
                    'Blur'
                    ? jsxRuntime.jsx(antd.Slider, {
                        min: 0,
                        max: 1,
                        step: 0.01,
                        value:
...
function ImageFx() {
  ...
  return jsxRuntime.jsx(
    antd.Form,
    Object.assign(
      { form: form, onValuesChange: handleFxValueChange },
      {
        children: jsxRuntime.jsx(
          FormItem$5,
          Object.assign(
            { name: 'filter' },
            { children: jsxRuntime.jsx(RadioImageGroup, {}) },
          ),
        ),
      },
    ),
    ...
    if (object) {
      ...
      form.setFieldsValue({
        border: Object.assign(
          Object.assign({ type: getObjectBorderType(border) }, border),
  ...
  return jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [
          ...
          { form: form, onValuesChange: handleValuesChange, colon: false },
          {
            children: [
              jsxRuntime.jsx(
                ...
                Object.assign(
                  { name: 'img' },
                  { children: jsxRuntime.jsx(ReplaceSetter, {}) },
                ),
              ),
              jsxRuntime.jsxs(
                antd.Row,
                    ...
                    children: [
                      jsxRuntime.jsx(
                        ...
                        Object.assign(
                          { span: 12 },
                          {
                            children: jsxRuntime.jsx(FormItem$4, {
                              children: jsxRuntime.jsx(ClipSetter, {
                                object: object,
                              }),
                            }),
                          },
                        ...
                        Object.assign(
                          { span: 12 },
                          {
                            children: jsxRuntime.jsx(
                              ...
                              Object.assign(
                                { name: 'border' },
                                { children: jsxRuntime.jsx(BorderSetter, {}) },
                              ),
                            ),
                          },
                        ),
      ...
      jsxRuntime.jsx(
        MoreConfigWrapper,
        Object.assign(
          { open: openFx, setOpen: setOpenFx, title: t('setter.image.filter') },
          { children: jsxRuntime.jsx(ImageFx, {}) },
        ),
      ),
    ],
  });
        ...
        children: [
          ...
          jsxRuntime.jsx(
            ...
            Object.assign(
              ...
              {
                children: jsxRuntime.jsx(antd.Radio.Group, {
                  children: LINE_BORDER_TYPES.map(item =>
                    jsxRuntime.jsx(
                      antd.Radio.Button,
                      Object.assign(
                        { value: item.key },
      ...
      { form: form, onValuesChange: handleValuesChange, colon: false },
      {
        children: [
          jsxRuntime.jsx(
            FormItem$2,
            Object.assign(
              { name: 'fill', label: t('common.color') },
              {
                children: jsxRuntime.jsx(ColorSetter, {
                  defaultColor: '#000000',
                }),
...
const items = [
  {
    key: 'flipX',
    label: jsxRuntime.jsx(reactI18next.Trans, {
      i18nKey: 'setter.common.flip_x',
    }),
  },
  {
    key: 'flipY',
    label: jsxRuntime.jsx(reactI18next.Trans, {
      i18nKey: 'setter.common.flip_y',
    }),
  },
];
    ...
    children: [
      jsxRuntime.jsx(
        ...
        Object.assign(
          ...
          { children: t('setter.common.adjust_position') },
        ),
      ),
      jsxRuntime.jsx(
        MoreConfigWrapper,
                                    ...
                                    Object.assign(
                                      { span: 8 },
                                      {
                                        children: jsxRuntime.jsx(
                                          ...
                                          Object.assign(
                                            {
                                              label: `${t('setter.size.width')}(${t('setter.common.px')})`,
                                              name: 'width',
                                            },
                                            {
                                              children: jsxRuntime.jsx(
                                    ...
                                    Object.assign(
                                      { span: 8 },
                                      {
                                        children: jsxRuntime.jsx(
                                          ...
                                          Object.assign(
                                            {
                                              label: `${t('setter.size.height')}(${t('setter.common.px')})`,
                                              name: 'height',
                                            },
                                            {
                                              children: jsxRuntime.jsx(
...
const ALIGH_TYPES = [
  ...
  {
    label: jsxRuntime.jsx(reactI18next.Trans, {
      i18nKey: 'setter.common.align_left',
    }),
  ...
  {
    label: jsxRuntime.jsx(reactI18next.Trans, {
      i18nKey: 'setter.common.center_h',
    }),
  ...
  {
    label: jsxRuntime.jsx(reactI18next.Trans, {
      i18nKey: 'setter.common.align_right',
    }),
  ...
  {
    label: jsxRuntime.jsx(reactI18next.Trans, {
      i18nKey: 'setter.common.align_top',
    }),
  ...
  {
    label: jsxRuntime.jsx(reactI18next.Trans, {
      i18nKey: 'setter.common.center_v',
    }),
  ...
  {
    label: jsxRuntime.jsx(reactI18next.Trans, {
      i18nKey: 'setter.common.align_bottom',
    }),
  ...
  return jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [
      jsxRuntime.jsxs(
        CenterV,
        Object.assign(
          { height: 30, gap: 8, justify: 'space-between' },
          {
            children: [
              jsxRuntime.jsx(
                ToolbarItem,
                Object.assign(
                  {
                    ...
                    onClick: handleLock,
                    title: lock
                      ? t('setter.common.unlock')
                      : t('setter.common.lock'),
                  },
                  {
                    children: lock
                      ? jsxRuntime.jsx(icons.UnlockOutlined, {
                          style: { fontSize: 20 },
                        })
                      : jsxRuntime.jsx(icons.LockOutlined, {
                          style: { fontSize: 20 },
                        }),
                  },
                ),
              ...
              jsxRuntime.jsx(
                ...
                Object.assign(
                  ...
                  {
                    children: jsxRuntime.jsx(OpacitySetter, {
                      value: opacity,
              ...
              jsxRuntime.jsx(
                ...
                Object.assign(
                  ...
                  {
                    children: jsxRuntime.jsx(icons.DeleteOutlined, {
                      style: { fontSize: 20 },
                    }),
                  },
                ),
              ...
              object.type === 'f-image'
                ? jsxRuntime.jsx(
                    ...
                    Object.assign(
                      ...
                      {
                        children: jsxRuntime.jsx(FlipSetter, {
                          onChange: handleFlip,
                        }),
                      },
                    ),
      ...
      jsxRuntime.jsx(antd.Divider, { style: { margin: '16px 0' } }),
      jsxRuntime.jsx(
        'span',
        Object.assign(
          { style: { fontWeight: 'bold' } },
          { children: t('setter.common.align') },
        ),
      ),
      jsxRuntime.jsx(
        CenterV,
            ...
            children: ALIGH_TYPES.map(item =>
              jsxRuntime.jsx(
                ...
                Object.assign(
                  ...
                  {
                    children: jsxRuntime.jsx(item.icon, {
                      style: { fontSize: 20 },
                    }),
                  },
                ),
...
function PathSetter() {
  ...
  React.useEffect(() => {
    if (object) {
      ...
      setValue({
        ...
        shadow: {
          color:
            (shadow === null || shadow === void 0 ? void 0 : shadow.color) ||
            '#000000',
          width:
            (shadow === null || shadow === void 0 ? void 0 : shadow.blur) || 0,
          offset:
            (shadow === null || shadow === void 0 ? void 0 : shadow.offsetX) ||
            0,
        },
      });
    }
  ...
  return jsxRuntime.jsx(PathSetterForm, {
    showFillConfig:
      object === null || object === void 0 ? void 0 : object.sub_type,
...
function RoughSetter() {
  ...
  return jsxRuntime.jsxs(
    antd.Form,
    Object.assign(
      { colon: false, form: form, onValuesChange: handleValuesChange },
      {
        children: [
          jsxRuntime.jsx(
            FormItem,
            Object.assign(
              { label: t('common.stroke'), name: 'stroke' },
              { children: jsxRuntime.jsx(SolidColorSetter, {}) },
            ),
          ),
          (object === null || object === void 0 ? void 0 : object.type) ===
          'group'
            ? jsxRuntime.jsx(
                FormItem,
                Object.assign(
...
function Setter() {
  ...
  const renderSetter = () => {
    ...
    if (Setter) {
      return jsxRuntime.jsxs(jsxRuntime.Fragment, {
        children: [Setter, jsxRuntime.jsx(antd.Divider, {})],
      });
    }
    return null;
  };
    ...
    return jsxRuntime.jsx(
      ...
      Object.assign(
        ...
        },
        {
          children: jsxRuntime.jsx(
            Title,
            Object.assign({ level: 5 }, { children: getSetterTitle() }),
          ),
        },
      ),
    );
...
const createGroup = options => {
  const { items, canvas } = options,
    rest = __rest(options, ['items', 'canvas']);
  const group = new fabric$1.fabric.Group(
    items,
    Object.assign({ id: uuid() }, rest),
  );
  canvas.add(group);
...
const createFTextClass = () => {
  fabric$1.fabric.FText = fabric$1.fabric.util.createClass(
    fabric$1.fabric.Textbox,
    {
      type: 'f-text',
      padding: 0,
      paintFirst: 'stroke',
  ...
  fabric$1.fabric.FText.fromObject = function (object, callback) {
    ...
    return fabric$1.fabric.Object._fromObject(
      'FText',
      objectCopy,
      function (textInstance) {
        textInstance.styles = fabric$1.fabric.util.stylesFromArray(
          object.styles,
          object.text,
        );
        if (path) {
          fabric$1.fabric.Object._fromObject(
            'Path',
            path,
...
const createFImageClass = () => {
  fabric$1.fabric.FImage = fabric$1.fabric.util.createClass(
    fabric$1.fabric.Group,
    {
      type: 'f-image',
      initialize(options, alreayGrouped = false) {
        const { image, imageBorder = {} } = options,
          rest = __rest(options, ['image', 'imageBorder']);
        image.set({
          originX: 'center',
          originY: 'center',
        });
  ...
  fabric$1.fabric.FImage.fromObject = (object, callback) => {
    const { objects } = object,
      options = __rest(object, ['objects']);
    const imgJson = Object.assign({}, objects[0]);
    fabric$1.fabric.Image.fromObject(imgJson, img => {
      callback(
        new fabric$1.fabric.FImage(
          Object.assign({ image: img }, options),
          true,
        ),
      );
    });
...
const createFLineClass = () => {
  fabric$1.fabric.FLine = fabric$1.fabric.util.createClass(
    fabric$1.fabric.Line,
    {
      type: 'f-line',
      padding: 6,
      borderColor: '#00000000',
      ...
      toObject(propertiesToInclude) {
        return extend$1(this.callSuper('toObject', propertiesToInclude), {
          x1: this.x1,
          y1: this.y1,
          x2: this.x2,
          y2: this.y2,
...
const createFArrowClass = () => {
  fabric$1.fabric.FArrow = fabric$1.fabric.util.createClass(
    fabric$1.fabric.Line,
    {
      type: 'f-arrow',
      borderColor: '#00000000',
...
const createFTriArrowClass = () => {
  fabric$1.fabric.FTriArrow = fabric$1.fabric.util.createClass(
    fabric$1.fabric.Line,
    {
      type: 'f-tri-arrow',
      borderColor: '#00000000',
...
class Editor {
  ...
  _adjustSketch2Canvas() {
    ...
    this.canvas.zoomToPoint(
      new fabric$1.fabric.Point(center.left, center.top),
      zoomLevel - 0.04,
    );
  ...
  _initEvents() {
    ...
    this.canvas.on('mouse:over', opt => {
      ...
      {
        const corner =
          target === null || target === void 0 ? void 0 : target.__corner;
        if (corner) {
    ...
    this.canvas.on('mouse:dblclick', opt => {
      ...
      const subTarget =
        subTargets === null || subTargets === void 0 ? void 0 : subTargets[0];
      if (
  ...
  export2Img(options) {
    ...
    const dataURL = this.canvas.toDataURL(
      Object.assign({ left, top, width, height, format: 'png' }, options),
    );
    ...
    return new Promise(resolve => {
      this.canvas.loadFromJSON(
        ...
        (o, obj) => {
          ...
          if (
            obj.id ===
            (lastActiveObject === null || lastActiveObject === void 0
              ? void 0
              : lastActiveObject.id)
          ) {
            nowActiveObject = obj;
...
function Fabritor() {
  ...
  const clickHandler = opt => {
    ...
    if (!target) {
      (_a = contextMenuRef.current) === null || _a === void 0
        ? void 0
        : _a.hide();
      return;
    }
    if (opt.button === 3) {
      ...
      (_b = contextMenuRef.current) === null || _b === void 0
        ? void 0
        : _b.hide();
    }
  };
                      ...
                      Object.assign(
                        { style: contentStyle },
                        {
                          children: jsxRuntime.jsx(
                            ContextMenu$1,
                            Object.assign(
                              { ref: contextMenuRef, object: activeObject },
                              {
                                children: jsxRuntime.jsx(
                                  'div',
                                  Object.assign(
