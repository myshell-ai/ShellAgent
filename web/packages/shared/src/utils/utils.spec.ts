...
describe('customSnakeCase', () => {
  it('should convert camelCase to snake_case', () => {
    ...
    expect(customSnakeCase('thisIsATest')).toBe('this_is_atest');
  });
  ...
  describe.skip('customSnakeCase utf-8', () => {
    ...
    it('should handle mixed Chinese, emojis and English', () => {
      ...
      expect(customSnakeCase('test测试🚀Case')).toBe(
        'test_6d4b_8bd5_1f680_case',
      );
    });
